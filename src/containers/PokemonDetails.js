    ...
    <View style={[Styles.mainContainer, Styles.backWhite]}>
      {
        isGetPokemonDetailsLoading ?
          <StaticContentComponent message="Fetching details" showLoader={true} />
          :
          null
      }
      {
        pokemonDetails ?
          ...
          :
          !isGetPokemonDetailsLoading && !pokemonDetails ?
            <StaticContentComponent message="No details found" />
            :
            null
      }
    </View>
